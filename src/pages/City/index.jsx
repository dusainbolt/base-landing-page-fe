...
import { IMG_SIDE_ABOUT, TOUR_BAN_CHAY, ĐD_LQ } from "../../common/configLandingPage";
  ...
  return (
    <div className="home about">
      <CarouselPage
        ...
        sideContent={<ContentSide titleSmall="Thay đổi điểm đến" titleCity="TP Hồ Chí Minh" titleButton="Việt Nam" />}
        className="home__carousel-page page-bottom content-side"
      />
      ...
      <LazyLoad height={800} throttle={400}>
        <FadeIn delay={100} transitionDuration={500}>
          <div className="home__row">
            ...
            <div>
              <Row gutter={[16, 16]}>{renderContentDV(ĐD_LQ, 8)}</Row>
            </div>
          </div>
        </FadeIn>
      </LazyLoad>
